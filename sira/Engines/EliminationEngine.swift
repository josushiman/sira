...
/// penalty, scaled by that Round's modifiers, and each Gösterge find (capped
/// at 1 per Entrant per Round) deducts 1 from the *other* team, never scaled.
/// The Match ends the moment any Entrant's total reaches 0 or below.
///
...
/// Okey 21 never needs to know which team called.
